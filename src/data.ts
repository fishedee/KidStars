import type { DollCategory, EnglishWord, Poem, ShopItem, VocabLesson } from './types';
...
export const DAILY_PHRASES = [
  ['Good morning!', '早上好！', '🌅'], ['How are you?', '你好吗？', '👋'], ["I'm fine, thank you.", '我很好，谢谢。', '😊'],
  ['Nice to meet you.', '很高兴认识你。', '🤝'], ['Thank you!', '谢谢你！', '🙏'], ["You're welcome.", '不客气。', '💖'],
  ['Goodbye!', '再见！', '👋'], ['See you later.', '待会见。', '👀'], ['What is your name?', '你叫什么名字？', '📛'],
  ['How old are you?', '你几岁了？', '🎂'], ['I like apples.', '我喜欢苹果。', '🍎'], ['Good night!', '晚安！', '🌙'],
].map(([en, cn, emoji]) => ({ en, cn, emoji }));
